...
# (1) w
sw <- w_inference(chains=list(sims1, sims2, sims3, sims4), B=B, p=p, n.sim=n.sim, warmup=n.sim/2+1, thin=1, filename="PD2_Join_w_trace.pdf", plot=F, d=3)
...
tiff("Fig5s.tiff", height=10, width=10, res=300, units="in")
par(mfrow=c(3, 3))
for(j in 1:9) {
...
tiff("Fig6s.tiff", width=10, height=10, res=300, units="in")
...
range(R_hat)  # 0.9929357 1.0226034


# save image for later use
save.image("PD2_Join_fit.Rdata")
